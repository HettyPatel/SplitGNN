...
class PolyConv(nn.Module):
    def __init__(self,
        ...
        self.attention_layer = nn.Linear(in_feats*len(thetas), 1, bias)
    ...
    def forward(self, graph, feat):
        ...
        with graph.local_scope():
            ...
            attention_score = self.attention_layer(hs_o)
            hs_o = hs_o * attention_score
...
class RelationAware(nn.Module):
    def __init__(self, input_dim, output_dim, dropout):
        ...
        self.attention_layer = nn.Linear(3*output_dim, 1, bias=False)
    ...
    def forward(self, src, dst):
        ...
        attention = self.attention_layer(e_feats)
        e_feats = e_feats * attention
